...
Public Sub GTKForms
	...
	Image1.Bitmap = LoadBitmapResize(File.DirAssets,"QRCodeSubModule-77ea9.png",Image1.Width,Image1.Height,False)
	mBase.AddView(btnBack,0.01 * mBase.Width,0.01 * mBase.Height,0.20 * mBase.Width,0.09 * mBase.Height)
	mBase.AddView(p_Qr,0.06 * mBase.Width,0.20 * mBase.Height,0.88 * mBase.Width,0.57 * mBase.Height)
...
End Sub
Sub p_Qr_click()
	'System generated Patient QR Code
