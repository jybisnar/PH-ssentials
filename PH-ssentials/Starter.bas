...
Sub Process_Globals
	...
	'Dim GPS1 As GPS
	Dim PLogin1 As Object       '1
	Dim PHome1 As Object        '2
	Dim PProfile1 As Object       '3
	Dim PQr1 As Object       '4
	Dim PSchedule1 As Object       '5
	Dim PAppointment1 As Object       '6
	Dim PUpdates1 As Object       '7
	Dim PLogs1 As Object       '8
	Dim PMedication1 As Object       '9
	
	Type MyType (Id As String, Prefix As String, First As String, Last As String, Address As String, City As String _
	, State As String, County As String, Zip As String _
	, Start As String, Stop As String, DescriptionMed As String, DescriptionAppoint As String, Dispenses As String _
	, Percent As String, progIncrement As String _
	, provider As String, Lat As String, Lon As String _
	, encounterProblem As String)
	Dim user As MyType
...
Sub Service_Create
	...
	user.Initialize()
	user.Initialize()
	user.Id="1234" 'This will get overridden by the back end.
	user.Prefix="Ms."
	user.First="Jane"
	user.Last="Doe"
	user.Address="123 Bocobo St."
	user.City="Manila"
	user.State="NCR"
	user.County= "Malate"
	user.Zip = "1215"
	...
	user. Stop = " "
	user.DescriptionMed = " "
	user.DescriptionAppoint= " "
	user.Dispenses = " "
	user.provider= " "
	user.Lat= " "
	user.Lon=" "
	user.encounterProblem = " "
