...
Public Sub GTKForms
	...
	Image1.Bitmap = LoadBitmapResize(File.DirAssets,"ProfileSubModule-783e7.png",Image1.Width,Image1.Height,False)
	mBase.AddView(btnLogout,0.34 * mBase.Width,0.92 * mBase.Height,0.32 * mBase.Width,0.06 * mBase.Height)
	mBase.AddView(btnQr,0.82 * mBase.Width,0.02 * mBase.Height,0.12 * mBase.Width,0.06 * mBase.Height)
	mBase.AddView(btnBack,0.04 * mBase.Width,0.02 * mBase.Height,0.12 * mBase.Width,0.06 * mBase.Height)
	mBase.AddView(lblName,0.08 * mBase.Width,0.36 * mBase.Height,0.84 * mBase.Width,0.08 * mBase.Height)
	mBase.AddView(lbl_ID,0.07 * mBase.Width,0.59 * mBase.Height,0.86 * mBase.Width,0.04 * mBase.Height)
	mBase.AddView(lblAddress,0.07 * mBase.Width,0.67 * mBase.Height,0.86 * mBase.Width,0.05 * mBase.Height)
	mBase.AddView(lblCounty,0.07 * mBase.Width,0.76 * mBase.Height,0.36 * mBase.Width,0.05 * mBase.Height)
	mBase.AddView(lblZip,0.53 * mBase.Width,0.76 * mBase.Height,0.41 * mBase.Width,0.05 * mBase.Height)
	mBase.AddView(lblState,0.07 * mBase.Width,0.84 * mBase.Height,0.86 * mBase.Width,0.05 * mBase.Height)
...
End Sub
Sub btnLogout_click()
	Dim p_Logout As PLogin
	p_Logout=Starter.PLogin1
	p_Logout.Visible=True
	setVisible(False)
End Sub
Sub btnQr_click()
	Dim qrCode As PQr
...
End Sub
Sub lblName_click()
	'Name from patients.csv
End Sub
Sub lbl_ID_click()
	'ID from patients.csv
End Sub
Sub lblAddress_click()
	'Address from patients.csv
End Sub
Sub lblCounty_click()
	'County from patients.csv
End Sub
Sub lblZip_click()
	'Zip from patients.csv
End Sub
Sub lblState_click()
	'State from patients.csv
End Sub
