...
Public Sub GTKForms
	...
	Image1.Bitmap = LoadBitmapResize(File.DirAssets,"frmsplash.jpg",Image1.Width,Image1.Height,False)
	mBase.AddView(Layout1,0.40 * mBase.Width,0.75 * mBase.Height,0.23 * mBase.Width,0.15 * mBase.Height)
	Layout1.Color =  Colors.ARGB(10,0,0,255)	
